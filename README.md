...
Edie is the smiling child who welcomes everyone to the pond. She is named in honor of Edith Barretto Parsons, the sculptor of the beloved Frog Baby fountain at Ball State University in Muncie, Indiana, which inspired this whole project.
Hop (the green frog) loves counting one lily pad at a time.
Skip (the teal frog) loves leaping ahead by twos, fives, and tens.
...
Teachers know best what their classrooms need. If you have an idea for a game, or you spot a bug, please open an issue on this repository.

This project was inspired by KingsMath, an amazing collection of classroom games built by an elementary teacher in South Korea.
